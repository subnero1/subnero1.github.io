...
**Singapore, February 23, 2026** – [Subnero Pte Ltd.](https://subnero.com/){:target="_blank"}, a leader in underwater wireless communication solutions, today announced the release of a new case study showcasing how its software-defined acoustic smart modems are empowering cutting-edge marine research in collaboration with the [Underwater Acoustic & Navigation Lab (ANL)](https://sites.google.com/edu.haifa.ac.il/anl){:target="_blank"}.

The newly published case study highlights how researchers, led by [Dr. Roee Diamant](https://www.linkedin.com/in/roee-diamant-17205363/){:target="_blank"}, utilized Subnero modems to bypass the closed architectures of traditional commercial acoustic systems. By leveraging Subnero’s open, software-defined platform, the ANL team successfully implemented multiple advanced sensing applications such as midwater Doppler motion estimation, lab-grade transducer characterization, and 3D biological tracking using active and passive sonar techniques without the need for expensive, time-consuming custom hardware development.
...
> “The open architecture of the Subnero modem allowed us to treat the device not just as a communication tool, but as a fully programmable underwater laboratory," said _Dr. Roee Diamant, Head of the Underwater Acoustic & Navigation Lab (ANL)_. "By accessing raw data and running our own code directly on the modem, we could bypass any hardware development and focus immediately on validating our algorithms in the open sea.”
