...
![Subnero L12L series long-range acoustic smart modems]({{site.baseurl}}/images/pulse-lf-pr.jpg)
*Subnero L12L series long-range acoustic smart modems*
{: .post-image-wrap}
...
- User-defined communication schemes supported through [UnetStack]({{ site.baseurl }}/products/wnc/unetstack/)
...
_**About Subnero:** Subnero serves defense, marine, subsea, offshore energy, and scientific research sectors with global customers, enabling a range of use cases in the most demanding conditions. For more information, visit [Subnero's website](https://subnero.com)._
