...
For many subsea operators, acoustic communication and underwater positioning have traditionally meant two separate systems, two sets of hardware on the deployment frame, and two lines on the budget. But what if the modem you already use to talk to your AUV could also tell you exactly where it is?
