...
*Singapore, March 11, 2024* – Subnero Pte. Ltd., a leading provider of underwater communication solutions headquartered in Singapore, proudly announces the launch of its latest innovation, the [S40H series](/products/wnc/gen4x/s40hsilver){:target="_blank"} of high-speed acoustic smart modems, marking a significant advancement in wireless networked communication ([WNC](/products/wnc/){:target="_blank"}) technology.

![Subnero S40H series high-speed acoustic smart modems]({{site.baseurl}}/images/pulse-hf-pr.jpg)
*Subnero S40H series high-speed acoustic smart modems*
{: .post-image-wrap}
...
- **Enhanced Capability:** The [multi-receiver variant](/products/wnc/gen4x/multi-receiver.html){:target="_blank"} of the modem further enhances performance through robust links supported by leveraging spatial diversity combining techniques.
- **Powered by UnetStack:** Leveraging [UnetStack](/products/unetstack/){:target="_blank"}, a versatile software framework for underwater communications and networking, the S40H series delivers unparalleled performance and adaptability.
