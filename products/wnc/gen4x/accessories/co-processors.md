  ...
  <section class="intro category-container">
    <div class="category-row">
      ...
      <div class="large-7 columns">
        ...
        <p>Available on the Gold Edition, the co-processor is a <strong>Jetson Orin Nano</strong>, bringing GPU-accelerated AI and deep learning capabilities directly into the modem for compute-intensive edge applications. It is available as an optional upgrade on all Gold Edition standalone configuration (SC) builds, in all receive channel configurations. It is not offered on the open configuration (OC), where integrators typically supply their own compute.</p>
        ...
        <table class="specification-table">
          ...
          <tbody>
            ...
            <tr>
              <td>Availability</td>
              <td>Gold Edition only, on all standalone configuration (SC) builds, in all receive channel options</td>
            </tr>
          </tbody>
        </table>
      </div>
