---
layout: default
title: L12L Series Gold Edition | High-Compute Long-Range Acoustic Smart Modem
description: Gold Edition L12L series modem with enhanced compute capability, Jetson Orin Nano co-processor support, and up to 4 receive channels as an optional upgrade for advanced long-range underwater deployments.
...
<div class="product-details">
  <section class="intro category-container">
    <div class="category-row no-padding">
        ...
        <div class="product-images">
          <div class="main-slider">
            <div class="slider-track">
              <img class="main-img" src="{{site.baseurl}}/images/gen4x/L12L-gold-gallery-01.png" alt="Subnero L12L Series Gold Edition low-frequency (LF) acoustic smart modem">
            </div>
          </div>
          <div class="thumbs">
            <img class="selected-thumb" data-index="0" src="{{site.baseurl}}/images/gen4x/L12L-gold-thumb-01.png" alt="Subnero L12L Series Gold Edition LF modem thumbnail">
          </div>
        </div>
        <!-- ./slider -->
      </div>
      <div class="large-7 columns">
        ...
        <h1>L12L Series</h1>
        <h2>9 - 16 kHz Band</h2>
        <p>The Gold Edition L12L series modem brings enhanced compute capability and optional multi-receiver support to the long-range LF acoustic platform. Built on the same proven acoustic foundation as the Silver Edition, it adds significantly greater processing capability, including support for the Jetson Orin Nano co-processor, and scales up to 4 receive channels, enabling advanced array processing, spatial diversity, and high-fidelity acoustic sensing over extended distances.</p>
        <h3>Applications</h3>
        <ul>
          <li>Long-range underwater acoustic research requiring multi-receiver signal processing</li>
          <li>Persistent monitoring networks with onboard AI inference and edge compute</li>
          <li>Communication and tracking of AUVs and subsea vehicles over extended distances</li>
        </ul>
  ...
  <section class="features category-container">
    <div class="category-row">
      ...
      <div class="large-5 columns">
        <img src="{{site.baseurl}}/images/gen4x/L12L-gold-feature.png" alt="Subnero L12L Series Gold Edition low-frequency (LF) acoustic smart modem" />
      </div>
    </div>
  </section>
  ...
  <section class="configs">
    <header>
      ...
      <p>Available in standalone, and open configurations to suit a range of deployment needs, from self-contained setups to integrated systems. Up to 4 receive channels are available as an <a href="{{site.baseurl}}/products/wnc/gen4x/accessories/multi-receiver.html">optional upgrade</a>.</p>
    </header>
    <div class="card-wrapper">
      <a class="product-card card-dialog" href="javascript:void(0)" data-product="wnc-l12lgs4x">
        <h2>WNC-L12LGS4X</h2>
        <div class="product-img">
          <img src="{{site.baseurl}}/images/gen4x/L12L-gold-sc-preview.png" alt="Subnero WNC-L12LGS4X Gold Edition Standalone Configuration Preview">
        </div>
        <h3>Standalone Configuration</h3>
        <p>Self-contained modem powered by an external battery or power supply.</p>
      </a>
      <a class="product-card card-dialog" href="javascript:void(0)" data-product="wnc-l12lgo4x">
        <h2>WNC-L12LGO4X</h2>
        <div class="product-img">
          <img src="{{site.baseurl}}/images/gen4x/L12L-gold-oc-preview.png" alt="Subnero WNC-L12LGO4X Gold Edition Open Configuration Preview">
        </div>
    ...
    <dialog id="configModal" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="main">
          <div class="main modal-content-item" data-product="wnc-l12lgs4x">
          ...
          <div class="main modal-content-item" data-product="wnc-l12lgo4x">
      ...
      <div class="large-4 columns">
        ...
        <div class=brochures>
          <a class="download-file" href="{{site.baseurl}}/brochures/gen4x-L12L-modems.pdf" target="_blank">
            <img src="{{site.baseurl}}/brochures/gen4x-L12L-modems.jpg" alt="Subnero L12L Series Underwater Modems brochure">
      ...
      <div class="large-8 columns">
        ...
        <table class="specification-table">
          ...
          <tbody>
            ...
            <tr>
              <td>Dimensions</td>
              <td>SC: ø 100 x 390 mm, OC: ø 100 x 210 mm</td>
            </tr>
            <tr>
