...
<section class="g4x-section" id="smart-modems">
  ...
  <div class="row large py2">
    <h4 class="comparison-table-caption">Performance Highlights</h4>
    <div class="comparison-table-wrap">
      <table class="comparison-table">
        ...
        <thead>
          <tr>
            <th>Feature</th>
            <th>L12L Series (LF)</th>
            <th>M25M Series (MF)</th>
            <th>S40H Series (HF)</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <td>
              <a class="comparison-img" href="{{site.baseurl}}/products/wnc/gen4x/s40h" title="S40H Series Modem">
                <img
  ...
  <div class="row large relative">
    <div class="feature-grid col3">
      <div class="card-unet-eco">
        ...
        <h4>UnetSim</h4>
        <p>Network Development Platform & Simulator. Design protocols using high-level APIs on your laptop.</p>
      </div>
      <div class="card-unet-eco">
        <div class="card-svg">
