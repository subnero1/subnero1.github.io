	...
	<ul class="edition-container">
		<li class="modem-container">
			...
			{% for page in product_pages %}
		        ...
		        <div class='mod modBlogPost bg-grey'>
		        	<a href="{{site.baseurl}}{{page.url}}"><img alt="Subnero Modem Co-processors" src="{{site.baseurl}}/{{page.thumbnail}}"/>
		          	<div class='content'>
		            <h2>Co-processors</h2>
		          </div></a>
		        </div>
		...
		<li class="modem-container">
			...
			{% for page in product_pages %}
		        ...
		        <div class='mod modBlogPost bg-grey'>
		        	<a href="{{site.baseurl}}{{page.url}}"><img alt="Subnero Modem Supported Sensors" src="{{site.baseurl}}/{{page.thumbnail}}"/>
		          	<div class='content'>
		            <h2>Sensors</h2>
		          </div></a>
		        </div>
	...
	<ul class="edition-container">
		<li class="modem-container">
			...
			{% for page in product_pages %}
		        ...
		        <div class='mod modBlogPost bg-grey'>
		        	<a href="{{site.baseurl}}{{page.url}}"><img alt="Subnero Modem Hull Options" src="{{site.baseurl}}/{{page.thumbnail}}"/>
		          	<div class='content'>
		            <h2>Hull Options</h2>
		          </div></a>
		        </div>
		...
		<li class="modem-container">
			...
			{% for page in product_pages %}
		        ...
		        <div class='mod modBlogPost bg-grey'>
		        	<a href="{{site.baseurl}}{{page.url}}"><img alt="Subnero Modem Cable Options" src="{{site.baseurl}}/{{page.thumbnail}}"/>
		          	<div class='content'>
		            <h2>Cables</h2>
		          </div></a>
		        </div>
