...
For compute-intensive tasks, such as implementing a custom physical layer, Subnero modems offer the option to include an [additional coprocessor](http://subnero.com/products/wnc/gen4x/co-processors.html), such as the NVIDIA Jetson Orin Nano, to handle high-demand processing requirements.
