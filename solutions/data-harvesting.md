---
layout: default
title: Autonomous Subsea Data Harvesting and Operations
    ...
    <div class="feature-grid col3 dark-card">
      ...
      <div class="docs-card column-card data-harvesting">
        ...
        <div>
          ...
          <p>The mission continues autonomously to the next lander, allowing one USV to harvest data from an entire underwater network in a single run.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="g4x-section">
  <div class="g4x-section-head relative">
    <h2 class="sec-head lg text-gradient g-orange normal-spacing">Strategic Applications</h2>
  </div>
  <div class="row large py2 relative">
    <div class="feature-grid col4 strategic-apps">
      ...
      <div class="docs-card uj column-card">
        ...
        <div>
          ...
          <p>Accelerate metocean modeling and site readiness.</p>
        </div>
      </div>
      <div class="docs-card uj column-card">
        <div class="img-wrapper">
      ...
      <div class="docs-card uj column-card">
        ...
        <div>
          ...
          <p>Monitor chemistry and stability at sensitive shipwreck sites.</p>
        </div>
      </div>
    </div>
  </div>
